...
const statusMap = {
    ...
    preparing: { label: 'Dimasak', color: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400' },
    ready: { label: 'Siap', color: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' },
    served: { label: 'Disajikan', color: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' },
