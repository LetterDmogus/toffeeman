...
const fields: FormField[] = [
    { key: 'name', label: 'Nama Topping', type: 'text', placeholder: 'Contoh: Ekstra Keju', required: true },
    { key: 'price', label: 'Harga (Rp)', type: 'number', required: true },
    { key: 'is_active', label: 'Status Aktif', type: 'select', required: true, options: [{ value: true, label: 'Ya' }, { value: false, label: 'Tidak' }] },
];
</script>
